...
func TestDay4_Part1(t *testing.T) {
	require.Equal(t, 2, Solve(strings.NewReader(input), false))
}
...
pid:3556412378 byr:2007`
	require.Equal(t, 0, Solve(strings.NewReader(input), true))
...
iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719`
	require.Equal(t, 4, Solve(strings.NewReader(input), true))
